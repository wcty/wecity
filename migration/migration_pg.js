...
const mongoInitiatives =require('./initiatives/mongo.json')
...
const addKey = gql`
    mutation AddInitiative($en:String, $uk:String, $key:String, $category:String) {
        insert_initiative (objects: {en: $en, uk: $uk, key: $key, category: $category}) {
        affected_rows
        }
    }
 `  
